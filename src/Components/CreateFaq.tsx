  ...
  return (
    <>
      ...
      >
        ...
        {/* Icon Name */}
        <div>
          <label className='block text-white mb-1 font-medium'>Icon Name (Lucide)</label>
          <input
            type='text'
            {...register('iconName', { required: 'Icon name is required' })}
            className='w-full px-4 py-3 rounded-xl bg-white/10 text-white placeholder-gray-300 outline-none border border-white/10 focus:border-purple-400 transition'
            placeholder='e.g. HelpCircle, Sparkles, Shield'
          />
        </div>
