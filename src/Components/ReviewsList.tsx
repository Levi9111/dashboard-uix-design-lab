...
const ReviewsList = () => {
  ...
  const reviews = data?.data as Review[] | undefined;
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
          {reviews.map((review: Review) => (
            ...
            >
              ...
              <div>
                <h3 className='text-lg font-bold'>{review.company || review.title || 'Review'}</h3>
                <p className='text-sm text-gray-300'>{review.testimonial || review.description}</p>
              </div>
